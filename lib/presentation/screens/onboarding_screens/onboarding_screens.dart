                          ...
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                  textStyle: GoogleFonts.inter(color: ColorsManager.black,fontWeight: FontWeight.w800,fontSize: 20.sp),
              ...
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [Color(0xFF084250).withOpacity(0.5), Color(0xFF084250)],
                  ),
                ),
              ),
              Align(
              ...
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [Color(0xFF85210E).withOpacity(0.5), Color(0xFF85210E)],
                  ),
                ),
              ),
              Align(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                  textStyle: GoogleFonts.inter(color: ColorsManager.faintYellow,fontWeight: FontWeight.w800,fontSize: 20.sp),

                                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16),side: BorderSide(color: ColorsManager.faintYellow,width: 2.w)),
              ...
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [Color(0xFF4C2471).withOpacity(0), Color(0xFF4C2471)],
                  ),
                ),
              ),
              Align(
              ...
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [Color(0xFF601321).withOpacity(0), Color(0xFF601321)],
                  ),
                ),
              ),
              ...
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [Color(0xFF2A2C30).withOpacity(0), Color(0xFF2A2C30)],
                  ),
                ),
              ),
              Align(
